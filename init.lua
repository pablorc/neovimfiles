    ...
    opts = {
      ...
      on_attach = function(bufnr)
        vim.keymap.set(
          ...
          { buffer = bufnr, desc = "[G]it [N]ext diff chunk" }
        )
        vim.keymap.set(
          "n",
          "<leader>gp",
          require("gitsigns").next_hunk,
          { buffer = bufnr, desc = "[G]it [P]revious diff chunk" }
        )
        vim.keymap.set(
          "n",
          "<leader>gc",
          require("gitsigns").preview_hunk,
          { buffer = bufnr, desc = "[G]it preview [C]hunk" }
        )
      end,
    },
  },
...
require("telescope").setup({
  ...
  defaults = {
    file_ignore_patterns = { "node_modules", ".git", "yarn.lock", "env" },
    mappings = {
      i = {
        ["<C-u>"] = false,
        ["<C-d>"] = false,
